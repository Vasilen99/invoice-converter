...
const BulgarianInvoice = React.forwardRef<HTMLDivElement, Props>(
  ({ data }, ref) => {
    ...
    return (
      <div ref={ref} style={pageStyle}>
        ...
        >
          <span style={{ fontWeight: 700, fontSize: "14pt", letterSpacing: 0 }}>
            {data.sellerName}
          </span>
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontSize: "11pt", fontWeight: 600, marginTop: 2 }}>
              No: {data.invoiceNumber} &nbsp; ОРИГИНАЛ
            </div>
          </div>
        </div>
        ...
        >
          <tbody>
            <tr>
              ...
              {/* Recipient */}
              <td
                style={{ width: "50%", verticalAlign: "top", paddingLeft: 8 }}
              >
                <table
                  style={{
                    width: "100%",
        ...
        >
          <tbody>
            <tr>
              ...
              <td style={{ ...tdStyle, background: "#fff", width: "17%" }}>
                {formatDateToBG(data.invoiceDate)} г.
              </td>
              <td
                style={{
                  ...tdStyle,
              ...
              <td style={{ ...tdStyle, background: "#fff", width: "17%" }}>
                {formatDateToBG(data.taxEventDate)} г.
              </td>
            </tr>
            <tr>
              <td
              ...
              <td colSpan={3} style={{ ...tdStyle, background: "#fff" }}>
                {data.location || ""}
              </td>
            </tr>
          </tbody>
        ...
        >
          ...
          <tbody>
            {data.lineItems.map((item, i) => (
              <tr
                key={i}
                style={{ background: i % 2 === 0 ? "#fff" : LIGHT_BLUE_BG }}
              >
            ...
            {/* Filler rows */}
            {Array.from({ length: Math.max(0, 5 - data.lineItems.length) }).map(
              (_, i) => (
                <tr key={`e${i}`}>
        ...
        >
          <tbody>
            <tr>
              {/* Payment info — left */}
              <td
                style={{ width: "55%", verticalAlign: "top", paddingRight: 8 }}
              >
                <table
                  style={{
                    width: "100%",
              ...
              {/* Totals — right */}
              <td
                style={{ width: "45%", verticalAlign: "top", paddingLeft: 8 }}
              >
                <table
                  style={{
                    width: "100%",
                ...
                >
                  <tbody>
                    ...
                    <tr>
                      ...
                      >
                        <span style={{ fontWeight: 600 }}>Словом: </span>
                        {data.totalInWords}
                      </td>
                    </tr>
                  </tbody>
